...
function library:Load(Name, Offset, Watermark, Padding, TextSize)
    ...
    background.Size = (drawings[utility.getLength(drawings)].Position + Vector2.new(50, 0)) - Vector2.new(0, 10);
end
...
function library:CreateLabel(text)
    ...
    self.background.Size = (drawings[utility.getLength(drawings)].Position + Vector2.new(50, 0)) - Vector2.new(0, 10);
